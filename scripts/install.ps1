...
function Get-LatestVersion {
    try {
        $latestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/wellssahara/cursor-free-vip/releases/latest"
        return @{
...
Write-Host "Created by wellssahara`n" -ForegroundColor $Theme.Info
